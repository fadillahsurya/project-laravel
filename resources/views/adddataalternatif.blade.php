              ...
              <form method="POST" action="{{ url('/alternatif/store')}}" class="form-horizontal">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="bahan" placeholder="Nilai Kriteria (bahan)" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="ulasan" class="col-sm-2 col-form-label">C4</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" name="ulasan" placeholder="Nilai Kriteria (ulasan)" required>
                    </div>
                  </div>
                  <div class="form-group row">
